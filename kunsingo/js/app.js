(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".home-service__slider")) resizableSwiper("(max-width: 991.98px)", ".home-service__slider", {
            modules: [ Navigation, Grid ],
            navigation: {
                prevEl: ".home-service__arrow--prev",
                nextEl: ".home-service__arrow--next"
            },
            grid: {
                rows: 2
            },
        ...
        if (document.querySelector(".home-gallery__slider")) new swiper_core_Swiper(".home-gallery__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
