(() => {
    ...
    function formFieldsInit(options = {
        ...
        if (options.viewPass) document.addEventListener("click", (function(e) {
            ...
            if (targetElement.closest('[class*="__viewpass"]')) {
                ...
                let isPasswordVisible = inputElement.getAttribute("type") === "text";
                inputElement.setAttribute("type", isPasswordVisible ? "password" : "text");
                targetElement.classList.toggle("_viewpass-active");
                if (isPasswordVisible) {
                    targetElement.classList.remove("_icon-eye-hide");
                    targetElement.classList.add("_icon-eye");
                } else {
                    targetElement.classList.remove("_icon-eye");
                    targetElement.classList.add("_icon-eye-hide");
                }
            }
        }));
    ...
    function initSliders() {
        ...
        if (document.querySelector(".new__slider")) new swiper_core_Swiper(".new__slider", {
            modules: [ Navigation, Pagination ],
            loop: true,
            autoHeight: true,
            speed: 800,
        ...
        if (mainProduct) {
            ...
            if (mainProductSliderImages.length) {
                ...
                mainProductThumbSlider = new swiper_core_Swiper(".thumb-slider__slider", {
                    loop: true,
                    direction: "vertical",
                    spaceBetween: 20,
                    speed: 800,
    ...
    function documentActions(e) {
        const targetElement = e.target;
        if (targetElement.closest(".icon-menu")) document.body.classList.toggle("menu-open");
        ...
        if (targetElement.closest(".rating__input")) {
            const currentElement = targetElement.closest(".rating__input");
            const rating = currentElement.closest(".rating");
            if (rating.classList.contains("rating--set")) starRatingGet(rating, currentElement);
        }
    ...
    function initProducts(data) {
        ...
        if (productsList.length) {
            ...
            productsList.forEach((productItem => {
                ...
                productTemplate += `</h4>`;
                if (productItem.label) productTemplate += `<div class="item-product__label">${productItem.label}</div>`;
