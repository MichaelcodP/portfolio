(() => {
    ...
    modules_flsModules.tippy = tippy_esm("#myTippy", {
    ...
    let copyBrands = document.querySelector(".brands__slide").cloneNode(true);
    document.querySelector(".brands__body").appendChild(copyBrands);
    window["FLS"] = true;
    menuInit();
})();