(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".traiding__slider")) new swiper_core_Swiper(".traiding__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            loop: true,
            pagination: {
                el: ".traiding__pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".traiding__arrow--prev",
                nextEl: ".traiding__arrow--next"
            },
            on: {}
        });
    }
