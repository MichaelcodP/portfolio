    ...
    function documentActions(e) {
        ...
        if (targetElement.closest(".nav-popular__item")) {
            ...
            if (!tabNavItem.classList.contains("active")) {
                ...
                if (activeTabNavItem) activeTabNavItem.classList.remove("active");
                ...
                const newActiveTabItem = tabItems[getIndex(tabNavItem)];
                if (newActiveTabItem) newActiveTabItem.classList.add("active");
            }
        }
